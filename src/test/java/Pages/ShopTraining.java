...
public class ShopTraining {
    ...
    @FindBy(css = "#training-side-nav")
    WebElement DogTrainingSideNav;
    ...
    // Constructor
    public ShopTraining (WebDriver _driver){
        this.driver = _driver;
    ...
    public void clickTrainingMenu()  {
        ...
        wait.until(ExpectedConditions.visibilityOf(DogTrainingTitle));
        this.driver.get(this.driver.getCurrentUrl() + "?test=true");
        wait.until(ExpectedConditions.visibilityOf(DogTrainingSideNav));
